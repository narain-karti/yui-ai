  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/ai/chat', {
        ...
        body: JSON.stringify({
          prompt: `As Yui AI's location concierge, answer this: ${query}. Focus on accessibility and real-time transit options. Provide practical suggestions with location names and tips.`
        }),
      });
      ...
      <div className="container-custom">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 gap-8">
          ...
          <p className="text-secondary max-w-md text-lg">
            Powered by AI, Yui provides up-to-date, accessible venue recommendations and transit alternatives.
          </p>
        </div>
